                                    ...
                                    <div style="float: right; padding-bottom: 10px;"> 
										...
										<form method="post" action="${pageContext.request.contextPath}/teacher/addTest">
											<table class = "table table-hover w-100 rounded" style="table-layout: auto; width: 100%; table-layout: fixed;">
												...
												<tr>	
													<td><input type="text" name="testTitle" class="form-control"></td>
												</tr>
												<tr>
													<th>testDate</th>
												</tr>
												<tr>	
													<td><input type="date" name="testDate" class="form-control"></td>
												</tr>
											</table>
											<div align="center">
											 <button type = "submit"  class="btn bg-gradient-info w-20 mt-4 mb-0">시험추가</button>		
											</div>
										</form>																		
