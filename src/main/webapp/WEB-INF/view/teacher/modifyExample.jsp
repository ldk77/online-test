                                    ...
                                    <div style="float: right; padding-bottom: 10px;"> 
										...
										<form method="post" action="${pageContext.request.contextPath}/teacher/modifyExample">
											<table class = "table table-hover w-100 rounded" style="table-layout: auto; width: 100%; table-layout: fixed;">
												...
												<tr>	
													<td><input type="text" name="exampleTitle" class="form-control" value="${exampleTitle}"></td>
												</tr>
												<tr>
													<th>exampleIdx</th>
												</tr>
												<tr>	
													<td><input type="number" name="exampleIdx" class="form-control" value="${exampleIdx}" min="1" max="4"></td>
												</tr>					
											</table>
											<input type="hidden" name="questionNo" value="${questionNo}">
											<div align="center">
											 <button type = "submit"  class="btn bg-gradient-info w-15 mt-0 mb-3">수정완료</button>
											 </div>		
										</form>																		
