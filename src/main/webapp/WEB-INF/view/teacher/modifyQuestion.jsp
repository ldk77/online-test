                                ...
                                <div class="card mb-4">                              
                                    ...
                                    <div style="float: right; padding-bottom: 10px;"> 
										...
										<form method="post" action="${pageContext.request.contextPath}/teacher/modifyQuestion">
											...
											<tr>	
												<td><input type="text" class="form-control" name="questionTitle" value="${questionTitle}"></td>
											</tr>
											<tr>
												<th>questionIdx</th>
											</tr>
											<tr>	
												<td><input type="number" class="form-control" name="questionIdx" value="${questionIdx}" min="1" max="10"></td>
											</tr>					
											</table>
											<input type="hidden" name="questionNo" value="${questionNo}">
											<div align="center">
											 <button type = "submit"  class="btn bg-gradient-info w-20 mt-4 mb-0">수정완료</button>
											 </div>		
										</form>																		
