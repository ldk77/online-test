                                    ...
                                    <div style="float: right; padding-bottom: 10px;"> 
										...
										<form method="post" action="${pageContext.request.contextPath}/teacher/addExample">
											<table class="table align-items-center mb-0">
												<tr>
													<td>questionNo</td>
													<td><input type="number" class="form-control" name="questionNo" value="${questionNo}" readonly="readonly"></td>
												</tr>
												<tr>
													<td>exampleIdx</td>
													<td><input type="number" class="form-control" name="exampleIdx" min="1" max="4"></td>
												</tr>
												<tr>
													<td>exampleTitle</td>
											...
											<div align="center">
											 <button type = "submit" class="btn bg-gradient-info w-35 mt-4 mb-0">시험추가</button>	</div>	
										</form>																		
