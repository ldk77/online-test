...
<a class="navbar-brand m-0" href="${pageContext.request.contextPath}/test/testList" target="_blank">
...
<li class="nav-item">
<a class="nav-link  " href="${pageContext.request.contextPath}/test/testList">
...
<li class="nav-item">
<a class="nav-link  " href="${pageContext.request.contextPath}/student/studentTestList">
<div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
<span class="nav-link-text ms-1">Test Score</span>
</a>
</li>
</c:if>
...
<li class="nav-item">
<c:if test="${loginStudent != null }">
<a class="nav-link  " href="${pageContext.request.contextPath}/student/modifyStudentPw">
<div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <div class="container-fluid px-4">
	<h1 class="mt-4">Online Test입니다. </h1>
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">${loginStudent.studentName} ${loginTeacher.teacherName}님이 접속 하였습니다.</li>
                        </ol>
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card mb-4">
                                    ...
                                    <c:if test="${loginTeacher != null}">                               
										...
										<table class = "table table-hover w-100 rounded" style="table-layout: auto; width: 100%; table-layout: fixed;">
											<tr>			
												<th>testTitle</th>
												<th>testDate</th>
												<th><c:if test="${loginTeacher != null}">수정/보기</c:if><c:if test="${loginStudent != null }">응시</c:if></th>	
												<c:if test="${loginTeacher != null}">
												<th>문제등록</th>	
												</c:if>	
											</tr>
											<c:forEach var="t" items="${list}">
												<tr>
													...
													<td>
													<c:if test="${loginTeacher != null}">   
													<a href="${pageContext.request.contextPath}/teacher/modifyTest?testNo=${t.testNo}&testTitle=${t.testTitle}&testDate=${t.testDate}">수정</a>
														/ <a href="${pageContext.request.contextPath}/test/testOne?testNo=${t.testNo}">보기</a>
														</c:if>
														<c:if test="${loginStudent != null }">
														<a href="${pageContext.request.contextPath}/student/addPaper?testNo=${t.testNo}">응시</a></c:if>
													</td>
													<c:if test="${loginTeacher != null}">
