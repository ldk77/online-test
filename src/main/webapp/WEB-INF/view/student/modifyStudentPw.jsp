										...
										<form method="post" action="${pageContext.request.contextPath}/student/modifyStudentPw">
											<table class="table align-items-center mb-0">
												<tr>
													<td>비밀번호</td>
													<td>
														<input type="email" name="oldPw" class="form-control" placeholder="Password" aria-label="Password" aria-describedby="password-addon">
													</td>
												</tr>
												<tr>
													<td>새비밀번호</td>
													<td>
														<input type="email" name="newPw" class="form-control" placeholder="Password" aria-label="Password" aria-describedby="password-addon">
													</td>
												</tr>			
											</table>
											 <button type = "submit"  class="btn bg-gradient-info w-100 mt-4 mb-0">수정완료</button>		
										</form>																		
