...
<a class="navbar-brand m-0" href="${pageContext.request.contextPath}/employee/empList" target="_blank">
...
<span class="nav-link-text ms-1">studentList</span>
</a>
</li>
<li class="nav-item">
...
<span class="nav-link-text ms-1">EmpList</span>
</a>
</li>
<li class="nav-item">
<a class="nav-link  " href="${pageContext.request.contextPath}/employee/teacherList">
<div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
<span class="nav-link-text ms-1">teacherList</span>
</a>
</li>
...
<a class="nav-link  " href="${pageContext.request.contextPath}/employee/modifyEmpPw">
<div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
<span class="nav-link-text ms-1">비밀번호 변경</span>
</a>
</c:if>
</li>
<li class="nav-item">
...
<div id="layoutSidenav_content">
  <div class="container-fluid px-4">
	<h1 class="mt-4">Online Test입니다. </h1>
                        
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">${loginStudent.studentName} ${loginTeacher.teacherName} ${loginEmp.empName}님이 접속 하였습니다.</li>
                        </ol>
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card mb-4">
                                    ...
                                    <div style="float: right; padding-bottom: 10px;">                                                                  
										...
										<a class="btn btn-outline-primary btn-sm mb-0 me-3" href="${pageContext.request.contextPath}/employee/addStudent">학생등록</a>
										...
										<table class = "table table-hover w-100 rounded" style="table-layout: auto; width: 100%; table-layout: fixed;">
												...
												<c:forEach var="s" items="${list}">
													<tr>
														<td>${s.studentId}</td>
														<td>${s.studentName}</td>
														<td><a class="btn btn-outline-primary btn-sm mb-0 me-3" href="${pageContext.request.contextPath}/employee/removeStudent?studentNo=${s.studentNo}">삭제</a></td>
													</tr>
												</c:forEach>
										</table>
										<form method="get" action="${pageContext.request.contextPath}/employee/studentList">							
											...
											<button type="submit" class="btn btn-outline-primary btn-sm mb-0 me-3">검색</button>											
										</form>
