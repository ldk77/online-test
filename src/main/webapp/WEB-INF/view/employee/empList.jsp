                            ...
                            <div class="col-xl-12">
                                <div class="card mb-4">
                                    ...
                                    <div style="float: right; padding-bottom: 10px;"> 
										...
										<a class="btn btn-outline-primary btn-sm mb-0 me-3" href="${pageContext.request.contextPath}/employee/addEmp">사원등록</a>
										...
										<table class = "table table-hover w-100 rounded" style="table-layout: auto; width: 100%; table-layout: fixed;">
											...
											<c:forEach var="e" items="${list}">
												<tr>
													<td>${e.empId}</td>
													<td>${e.empName}</td>
													<td><a class="btn btn-outline-primary btn-sm mb-0 me-3" href="${pageContext.request.contextPath}/employee/removeEmp?empNo=${e.empNo}">삭제</a></td>
												</tr>
											</c:forEach>
										</table>
